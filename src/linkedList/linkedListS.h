...
class linkedList final {
 	...
 	public:
  		...
  		using iterator = Iterator<
      			T, typename std::conditional<std::is_class<T>::value, std::true_type,
                                   std::false_type>::type>;
  		using const_iterator =
      		Iterator<const T, typename std::conditional<std::is_class<T>::value,
                                                  std::true_type,
                                                  std::false_type>::type>;
  		...
  		using const_reverse_iterator = ReverseIterator<
      		const T,
      		typename std::conditional<std::is_class<T>::value, std::true_type,
                                	std::false_type>::type>;
...
linkedList<T>::linkedList(linkedList const& outer) {
  	...
  	for (auto value : outer) push_back(value);
}
...
linkedList<T>::begin() { return list_.next_; }

template <typename T>
	typename linkedList<T>::const_iterator
linkedList<T>::begin() const { return list_.next_; }

template <typename T>
	typename linkedList<T>::const_iterator 
linkedList<T>::cbegin() const { return list_.next_; }

template <typename T>
	typename linkedList<T>::iterator 
linkedList<T>::end() { return &list_; }

template <typename T>
	typename linkedList<T>::const_iterator 
linkedList<T>::end() const { return &list_; }

template <typename T>
	typename linkedList<T>::const_iterator
linkedList<T>::cend() const { return &list_; }

template <typename T>
	typename linkedList<T>::reverse_iterator
linkedList<T>::rbegin() { return list_.prev_; }

template <typename T>
	typename linkedList<T>::const_reverse_iterator 
linkedList<T>::rbegin() const { return list_.prev_; }

template <typename T>
	typename linkedList<T>::const_reverse_iterator
linkedList<T>::crbegin() const { return list_.prev_; }

template <typename T>
	typename linkedList<T>::reverse_iterator
linkedList<T>::rend() { return &list_; }

template <typename T>
	typename linkedList<T>::const_reverse_iterator
linkedList<T>::rend() const { return &list_; }

template <typename T>
	typename linkedList<T>::const_reverse_iterator
linkedList<T>::crend() const { return &list_; }
