...
public:
	explicit Node(
		...
		Node* next=nullptr, 
		Node* prev=nullptr
		) noexcept : data_(value), next_(next), prev_(prev) {}

	explicit Node(
		T&& value,
		Node* next = nullptr,
		Node*prev = nullptr
		) noexcept : data_(std::move(value)), next_(next), prev_(prev) {}
...
public:
	...
	template <typename T>
class Iterator<T, std::true_type>: public ForwardIterator<T> {
...
public:
	...
	template <typename T, typename /*is_class*/ = std::false_type>
...
public:
	...
	template <typename T>
class ReverseIterator<T, std::true_type>: public BackwardIterator<T> {
...
linkedList<T>& linkedList<T>::operator=(linkedList<T> rhs) {
	...
	template <typename T>
bool linkedList<T>::empty() const { return head_ == nullptr; }

	template <typename T>
typename linkedList<T>::size_type 
linkedList<T>::size() const { return size_; }

	template <typename T>
std::optional<T> 
linkedList<T>::front() const { return !empty() ? *begin() : std::nullopt; }

	template <typename T>
std::optional<T> 
linkedList<T>::back() const {  return !empty() ? *rbegin() : std::nullopt; }

	template <typename T>
typename linkedList<T>::const_iterator
linkedList<T>::data() const { return begin(); }
...
void linkedList<T>::push_after(const U& key, U&& value) {
	...
	if ( curr == tail_ ) {
		push_back( std::forward<U>(value) ); return;
	}
...
void linkedList<T>::push_before(const U& key, U&& value) {
	...
	if ( head_->data_ == key ) {
		push_front(std::forward<U>(value)); return;
	}
...
void linkedList<T>::pop_after(const T& key) {
	...
	template <typename T>
typename linkedList<T>::iterator linkedList<T>::begin() { return head_; }

	template <typename T>
typename linkedList<T>::const_iterator  linkedList<T>::begin() const { return head_; }

	template <typename T>		
typename linkedList<T>::const_iterator  linkedList<T>::cbegin() const { return head_; }

	template <typename T>
typename linkedList<T>::reverse_iterator linkedList<T>::rbegin() { return tail_; }

	template <typename T>
typename linkedList<T>::const_reverse_iterator linkedList<T>::rbegin() const { return tail_; }

	template <typename T>		
typename linkedList<T>::const_reverse_iterator linkedList<T>::crbegin() const { return tail_; }		

	template <typename T>
typename linkedList<T>::iterator linkedList<T>::end() { return nullptr; }

	template <typename T>
typename linkedList<T>::const_iterator linkedList<T>::end() const { return nullptr; }

	template <typename T>
typename linkedList<T>::const_iterator linkedList<T>::cend() const { return nullptr; }

	template <typename T>
typename linkedList<T>::reverse_iterator linkedList<T>::rend() { return nullptr; }

	template <typename T>
typename linkedList<T>::const_reverse_iterator linkedList<T>::rend() const { return nullptr; }

	template <typename T>
typename linkedList<T>::const_reverse_iterator linkedList<T>::crend() const { return nullptr; }
